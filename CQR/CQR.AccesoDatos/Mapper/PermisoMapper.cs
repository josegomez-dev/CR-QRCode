...
namespace CQR.AccesoDatos.Mapper
{
    public class PermisoMapper : EntityMapper, IObjectMapper, ISqlStament
    {
        ...
        {
            var operation = new SqlOperation { ProcedureName = "RETALL_PERMISOS_PR" };
        ...
        internal SqlOperation GetRetrieveByRolStatement(Rol rol)
        {
            var operation = new SqlOperation { ProcedureName = "RET_PERMISO_BY_ROL_PR" };
